...
vol_8 = int(1)
vol_9 = int(1.2)
arr_volt = [vol_1, vol_2, vol_3, vol_4, vol_5, vol_6, vol_7, vol_8, vol_9]
...
def power():
    ...
    for i in range(s1):
        ...
        v1 = v/2
        v2 = v/-2
        val_volt = round(random.uniform(v1, v2), 2)
        v = v+val_volt
        round(v, 2)
        print('result: ' + str(v))
        nums.append(v)
...
def save():
    ...
    my_list = [vb_1, vb_2, vb_3, vb_4, vb_5, vb_6, vb_7, vb_8, vb_9, vb_10, vb_11, vb_12, vb_13, vb_14,
               ...
               ei1, ei2, ei3, ei4, ei5, ei6, ei7, ei8, ei9, ei10, ei11, ei12, ei13, ei14, ev1, ev2]
...
class POWER:
    def __init__(self, t, gr):
        self.t = Label(f_top_1, text=t)
        self.t.config(font=("Times", "6", "bold"))
        self.t.grid(row=gr, column=0)


f_power_1 = POWER('VOLTAGE_1 - 1 V', 0)
f_power_2 = POWER('VOLTAGE_2 - 1.1 V', 1)
f_power_3 = POWER('VOLTAGE_3 - 1.8 V', 2)
f_power_4 = POWER('VOLTAGE_4 - 1.5 V', 3)
f_power_5 = POWER('VOLTAGE_5 - 1.8 V', 4)
f_power_6 = POWER('VOLTAGE_6 - 3.3 V', 5)
f_power_7 = POWER('VOLTAGE_7 - 5 V', 6)
f_power_8 = POWER('VOLTAGE_8 - 1 V', 7)
f_power_9 = POWER('VOLTAGE_9 - 1.2 V', 8)

volt_COL_1 = Label(f_top_1, bg="lightgrey", text="-")
volt_COL_2 = Label(f_top_1, bg="lightgrey", text="-")
volt_COL_3 = Label(f_top_1, bg="lightgrey", text="-")
volt_COL_4 = Label(f_top_1, bg="lightgrey", text="-")
volt_COL_5 = Label(f_top_1, bg="lightgrey", text="-")
volt_COL_6 = Label(f_top_1, bg="lightgrey", text="-")
volt_COL_7 = Label(f_top_1, bg="lightgrey", text="-")
volt_COL_8 = Label(f_top_1, bg="lightgrey", text="-")
volt_COL_9 = Label(f_top_1, bg="lightgrey", text="-")

volt_COL_1.config(font=("Times", "5", "bold"))
volt_COL_2.config(font=("Times", "5", "bold"))
volt_COL_3.config(font=("Times", "5", "bold"))
volt_COL_4.config(font=("Times", "5", "bold"))
volt_COL_5.config(font=("Times", "5", "bold"))
volt_COL_6.config(font=("Times", "5", "bold"))
volt_COL_7.config(font=("Times", "5", "bold"))
volt_COL_8.config(font=("Times", "5", "bold"))
volt_COL_9.config(font=("Times", "5", "bold"))
volt_COL_1.grid(row=0, column=1, padx=50)
volt_COL_2.grid(row=1, column=1, padx=50)
volt_COL_3.grid(row=2, column=1, padx=50)
volt_COL_4.grid(row=3, column=1, padx=50)
volt_COL_5.grid(row=4, column=1, padx=50)
volt_COL_6.grid(row=5, column=1, padx=50)
volt_COL_7.grid(row=6, column=1, padx=50)
volt_COL_8.grid(row=7, column=1, padx=50)
volt_COL_9.grid(row=8, column=1, padx=50)

#COM
f_COM_1 = Label(f_top_2, text='PORT 1 (1-8)')
f_COM_2 = Label(f_top_2, text='PORT 2 (9-16)')
f_COM_1.grid(row=0, column=0)
f_COM_2.grid(row=1, column=0)

port_1 = Label(f_top_2, bg="lightgrey", text="-")
port_2 = Label(f_top_2, bg="lightgrey", text="-")
port_1.grid(row=0, column=1, padx=15, pady=25)
port_2.grid(row=1, column=1, padx=15, pady=25)
...
f_med_4 = Frame(nb, width=200, height=270)
f_med_5 = Frame(nb, width=200, height=270)
nb.add(f_med_1, text='  UARTS ')
nb.add(f_med_2, text='   SPI   ')
nb.add(f_med_3, text='   I2C   ')
nb.add(f_med_4, text='VOLTAGE')
nb.add(f_med_5, text='   UDP  ')
...
lab0_Voltage = Label(f_med_4, text='  Voltage  ').grid(row=1, column=0)
lab1_Voltage = Label(f_med_4, text='  count  ').grid(row=0, column=1)
lab2_Voltage = Label(f_med_4, text='delay (ms)').grid(row=0, column=2)
...
v1_ent = Entry(f_med_4, width=15)
v1_ent.grid(row=1, column=1, padx=50)
v2_ent = Entry(f_med_4, width=15)
v2_ent.grid(row=1, column=2, padx=50)
...
if not os.path.isfile('saved_config.dat'):
    ...
    with open('saved_config.dat', "rb") as in_f:
        try:
            ...
            ec1, ec2, ec3, ec4, ec5, ec6, ec7, ec8, ec9, ec10, ec11, ec12, ec13, ec14,\
            eps1, eps2, eps3, eps4, eps5, eps6, eps7, eps8, eps9, eps10, eps11,  eps12, eps13, eps14,\
            ei1, ei2, ei3, ei4, ei5, ei6, ei7, ei8, ei9, ei10, ei11, ei12, ei13, ei14, ev1, ev2 = pickle.load(in_f)
